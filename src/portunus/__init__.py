...
Public surface:
    ...
    LocalVault      ARCA, local encrypted-at-rest backend (Keychain master key) — the DEFAULT tier
    GcloudBackend   ARCA, GCP Secret Manager backend (shells to gcloud) — later, opt-in
"""
